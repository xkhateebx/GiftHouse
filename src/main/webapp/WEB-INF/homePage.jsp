    ...
    <div class="container-fluid">
        <div class="row  justify-content-center align-items-center d-flex text-center h-100">
            <div class="col-12 col-md-8  h-50 ">
                <h1 class="display-2  text-light mb-2 mt-5"><strong>Gift House</strong> </h1>
                <p class="lead  text-light mb-5">Buy Gift Cards Online with Gift House.</p>
                <p><a href="#section2" class="btn bg-danger shadow-lg btn-round text-light btn-lg btn-rised">Order Now ></a></p>
